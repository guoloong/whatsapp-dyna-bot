...
Examples:
- "Yes" after "Want to know more about RiFlex?" → Provide detailed product info
- "Yes" after "More details or where to buy?" → Provide more details about the product (ingredients, dosage, benefits, etc.)
- "Sure" after recommendation → Confirm choice and offer next steps like pricing or where to buy`;
